<?php
/**
 * U3A TOWNSVILLE functions and definitions
 *
...
if ( ! function_exists( 'u3a_townsville_setup' ) ) :
	...
	function u3a_townsville_setup() {
		 ...
		 * If you're building a theme based on U3A TOWNSVILLE, use a find and replace
		 * to change 'u3a-townsville' to the name of your theme in all the template files.
		 */
...
function u3a_townsville_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'u3a-townsville' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'u3a-townsville' ),
